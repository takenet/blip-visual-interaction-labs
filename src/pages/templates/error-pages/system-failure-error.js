...
export default function SystemFailureError() {
  return (
    <BdsGrid height="100vh" alignItems="center">
      ...
      >
        <BdsGrid xxs="7" xs="6" sm="6" justifyContent="center">
          <BdsIllustration type="default" name="management"></BdsIllustration>
        </BdsGrid>
        <BdsGrid className="textArea" xxs="12" xs="6" direction="column" gap="8">
          <BdsGrid direction="column" gap="2">
            ...
            <BdsTypo>
            Nossos times já estão trabalhando para reestabelecer o serviço. Tente novamente mais tarde ou acompanhe
                o status da nossa plataforma no link abaixo.
            </BdsTypo>
          </BdsGrid>
