        ...
        <div className="sidebar-content">
          ...
          <div className="sidebar-user sidebar-item">
            <div className="user-name">
              <bds-avatar
                size="small"
                name="Rafaella Soares Santos Ribeiro Lima"
                thumbnail="https://cdn1.iconfinder.com/data/icons/user-pictures/100/female1-512.png"
              ></bds-avatar>
              <bds-typo class="hidden item-primary" variant="fs-14" bold="bold">
                Rafaella Soares Santos Ribeiro Lima
              </bds-typo>
              <Link to="/main/account/config">
                <bds-icon
                  class="hidden"
                  size="x-small"
            ...
            <div className="config-user">
              <bds-typo class="hidden" variant="fs-10" bold="regular">
